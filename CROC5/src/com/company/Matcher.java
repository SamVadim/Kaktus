...
public class Matcher {
     ...
     * @param character символ, который требуется найти
     * @return {@code true} символ найден, иначе {@code false}
     * @throws IllegalArgumentException в случае, если в {@code character} пуст или более одного символа.
     * @throws NullPointerException     в случае {@code character} равного {@code null}
     */
